...
if __name__ == '__main__':
    ...
    model,train_dataloader,val_dataloader,test_dataloader = get_model_and_data(model_name=args.model,dataset=args.dataset,batch=args.batch)
    ...
    misclassified_save_path=os.path.join(save_dir, args.dataset + "_" + args.model+"_misclassified.csv")
    confusion_matrix_save_path=os.path.join(save_dir, args.dataset + "_" + args.model+ '_confusion_matrix.png')
    ...
    if args.mode in ['test', 'both']:
        ...
        inference(model, acc_metric, pre_metric, rec_metric, f1_metric, confusion, test_dataloader,
                                misclassified_save_path, confusion_matrix_save_path)
